  ...
  return (
    <div className="font-sans">
      <div className="relative h-56 mt-20">
        ...
        />
        <div
          className={`w-56 rounded-ss-[70px] absolute rounded-ee-[70px] h-56 bg-primary top-0 left-0`}
        ></div>
        <div
        ...
        <div className="w-6 z-10 h-[2px] bg-pink-600 absolute top-16 right-[75px] rotate-[110deg]"></div>
        <div className="w-6 z-10 h-[2px] bg-white absolute top-[65px] right-[70px] rotate-[120deg]"></div>
        <img
            src="homepageImg/img1.png"
            className=" top-[75px] absolute right-[55px] w-7 h-7"
            alt=""
          />
      ...
      <div className="flex flex-col gap-2 justify-start items-start mt-3">
        ...
        <div className="flex gap-5">
          ...
          <a href={facebook} target="_blank">
            <FaFacebookSquare className="hover:text-primary w-7 h-7 dark:text-gray-100" />
          </a>
        </div>
      </div>
    </div>
